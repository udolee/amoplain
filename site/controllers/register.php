...
return function ($site, $pages, $page) {
    ...
    if(r::is('post') and get('register') !== null) {
        ...
        $register_message = '';
        if (get('email') == '') $register_message .= '<p class="lh-solid mv1 dark-red">'.l('register-failure-email').'</p>';
        if (get('fullname') == '') $register_message .= '<p class="lh-solid mv1 dark-red">'.l('register-failure-fullname').'</p>';
        if (get('country') == '') $register_message .= '<p class="lh-solid mv1 dark-red">'.l('register-failure-country').'</p>';
